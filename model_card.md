...
This project shows my skill level as an AI engineer since I build testing systems and validate my code instead of fully trust AI solutions. I handled edge cases, made sure outputs made sense and wrote logic code which I used pytest to check whether my functions made sense. 
